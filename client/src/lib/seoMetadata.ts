...
export const toolsSEOData: ToolSEOData[] = [
  {
    ...
    metadata: {
      ko: {
        title: '온라인 계산기 | 무료 웹 계산기 - ToolHub.tools',
        description: '무료 온라인 계산기로 사칙연산, 과학계산을 빠르게 수행하세요. 모든 기기에서 사용 가능한 웹 기반 계산기입니다.',
        keywords: ['온라인 계산기', '무료 계산기', '웹 계산기', '사칙연산', '수학 계산기', '과학 계산기', '계산 도구'],
        ogTitle: '무료 온라인 계산기 - ToolHub.tools',
        ogDescription: '브라우저에서 바로 사용하는 무료 계산기. 설치 불필요, 빠른 계산.',
        canonical: 'https://toolhub.tools/calculator',
        hreflang: [
          { lang: 'ko', href: 'https://toolhub.tools/calculator?lang=ko' },
          { lang: 'en', href: 'https://toolhub.tools/calculator?lang=en' },
          { lang: 'ja', href: 'https://toolhub.tools/calculator?lang=ja' }
        ]
      },
      en: {
        title: 'Free Online Calculator | Web Calculator - ToolHub.tools',
        description: 'Free online calculator for basic arithmetic and scientific calculations. Web-based calculator available on all devices.',
        keywords: ['online calculator', 'free calculator', 'web calculator', 'math calculator', 'scientific calculator', 'calculation tool'],
        ogTitle: 'Free Online Calculator - ToolHub.tools',
        ogDescription: 'Free calculator that works in your browser. No installation required, fast calculations.',
        canonical: 'https://toolhub.tools/calculator',
        hreflang: [
          { lang: 'ko', href: 'https://toolhub.tools/calculator?lang=ko' },
          { lang: 'en', href: 'https://toolhub.tools/calculator?lang=en' },
      ...
      ja: {
        title: '無料オンライン電卓 | ウェブ電卓 - ToolHub.tools',
        description: '無料のオンライン電卓で四則演算や科学計算を素早く実行。全デバイスで利用可能なウェブベース電卓です。',
        keywords: ['オンライン電卓', '無料電卓', 'ウェブ電卓', '数学電卓', '科学電卓', '計算ツール'],
        ogTitle: '無料オンライン電卓 - ToolHub.tools',
        ogDescription: 'ブラウザで直接使用する無料電卓。インストール不要、高速計算。',
        canonical: 'https://toolhub.tools/calculator',
        hreflang: [
          { lang: 'ko', href: 'https://toolhub.tools/calculator?lang=ko' },
          { lang: 'en', href: 'https://toolhub.tools/calculator?lang=en' },
      ...
      zh: {
        title: '免费在线计算器 | 网页计算器 - ToolHub.tools',
        description: '免费在线计算器，支持基础运算和科学计算。适用于所有设备的网页计算器。',
        keywords: ['在线计算器', '免费计算器', '网页计算器', '数学计算器', '科学计算器', '计算工具'],
        ogTitle: '免费在线计算器 - ToolHub.tools',
        ogDescription: '浏览器直接使用的免费计算器。无需安装，快速计算。',
        canonical: 'https://toolhub.tools/calculator',
        hreflang: [
          { lang: 'ko', href: 'https://toolhub.tools/calculator?lang=ko' },
          { lang: 'en', href: 'https://toolhub.tools/calculator?lang=en' },
      ...
      es: {
        title: 'Calculadora Online Gratis | Calculadora Web - ToolHub.tools',
        description: 'Calculadora online gratuita para operaciones básicas y cálculos científicos. Calculadora web disponible en todos los dispositivos.',
        keywords: ['calculadora online', 'calculadora gratis', 'calculadora web', 'calculadora matemática', 'calculadora científica', 'herramienta de cálculo'],
        ogTitle: 'Calculadora Online Gratis - ToolHub.tools',
        ogDescription: 'Calculadora gratuita que funciona en tu navegador. Sin instalación, cálculos rápidos.',
        canonical: 'https://toolhub.tools/calculator',
        hreflang: [
          { lang: 'ko', href: 'https://toolhub.tools/calculator?lang=ko' },
          { lang: 'en', href: 'https://toolhub.tools/calculator?lang=en' },
      ...
      fr: {
        title: 'Calculatrice En Ligne Gratuite | Calculatrice Web - ToolHub.tools',
        description: 'Calculatrice en ligne gratuite pour les opérations de base et les calculs scientifiques. Calculatrice web disponible sur tous les appareils.',
        keywords: ['calculatrice en ligne', 'calculatrice gratuite', 'calculatrice web', 'calculatrice mathématique', 'calculatrice scientifique', 'outil de calcul'],
        ogTitle: 'Calculatrice En Ligne Gratuite - ToolHub.tools',
        ogDescription: 'Calculatrice gratuite qui fonctionne dans votre navigateur. Pas d\'installation, calculs rapides.',
        canonical: 'https://toolhub.tools/calculator',
        hreflang: [
          { lang: 'ko', href: 'https://toolhub.tools/calculator?lang=ko' },
          { lang: 'en', href: 'https://toolhub.tools/calculator?lang=en' },
      ...
      de: {
        title: 'Kostenloser Online-Rechner | Web-Rechner - ToolHub.tools',
        description: 'Kostenloser Online-Rechner für Grundrechenarten und wissenschaftliche Berechnungen. Web-basierter Rechner für alle Geräte.',
        keywords: ['Online-Rechner', 'kostenloser Rechner', 'Web-Rechner', 'Mathematik-Rechner', 'wissenschaftlicher Rechner', 'Rechenwerkzeug'],
        ogTitle: 'Kostenloser Online-Rechner - ToolHub.tools',
        ogDescription: 'Kostenloser Rechner für Ihren Browser. Keine Installation, schnelle Berechnungen.',
        canonical: 'https://toolhub.tools/calculator',
        hreflang: [
          { lang: 'ko', href: 'https://toolhub.tools/calculator?lang=ko' },
          { lang: 'en', href: 'https://toolhub.tools/calculator?lang=en' },
      ...
      ru: {
        title: 'Бесплатный Онлайн Калькулятор | Веб Калькулятор - ToolHub.tools',
        description: 'Бесплатный онлайн калькулятор для основных операций и научных вычислений. Веб-калькулятор для всех устройств.',
        keywords: ['онлайн калькулятор', 'бесплатный калькулятор', 'веб калькулятор', 'математический калькулятор', 'научный калькулятор', 'инструмент вычислений'],
        ogTitle: 'Бесплатный Онлайн Калькулятор - ToolHub.tools',
        ogDescription: 'Бесплатный калькулятор в браузере. Без установки, быстрые вычисления.',
        canonical: 'https://toolhub.tools/calculator',
        hreflang: [
          { lang: 'ko', href: 'https://toolhub.tools/calculator?lang=ko' },
          { lang: 'en', href: 'https://toolhub.tools/calculator?lang=en' },
