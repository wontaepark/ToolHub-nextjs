    ...
    <div>
      ...
      <div className="mb-10 md:mb-12 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 max-w-7xl mx-auto">
          ...
          {/* Weather Info */}
          <Link href="/weather">
            <div className="group tool-card bg-card rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl cursor-pointer transition-all duration-300 hover:scale-[1.02] md:hover:scale-105 border border-border/50 hover:border-sky-500/30 active:scale-[0.98]">
              <div className="h-32 md:h-40 bg-gradient-to-br from-sky-500 to-blue-500 flex items-center justify-center relative overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-sky-500/20 to-transparent"></div>
                <i className="ri-cloud-line text-white text-4xl md:text-6xl relative z-10 group-hover:scale-110 transition-transform duration-300"></i>
              </div>
              <div className="p-4 md:p-6">
                <div className="flex items-start justify-between mb-3">
                  <h3 className="font-bold text-lg md:text-xl leading-tight">{t('tools.weather.title')}</h3>
                  <Badge variant="default" className="bg-sky-500/10 text-sky-600 text-xs flex-shrink-0 ml-2">
                    {t('common.available')}
                  </Badge>
                </div>
                <p className="text-muted-foreground text-sm md:text-base mb-4 leading-relaxed">
                ...
                <div className="flex flex-wrap gap-1.5 md:gap-2">
                  ...
                  <Badge variant="outline" className="text-xs">{t('tools.weather.tags.2')}</Badge>
                </div>
              </div>
            </div>
          </Link>
